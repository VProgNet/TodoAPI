...
namespace TodoAPI
{
    public class GeneratedClass
    {
        ...
        public GeneratedClass(List<TodoItem> items)
        {
            _items = items;
        }
...
#region "Row Header"
            /*TableRow tableRow1 = new TableRow() { RsidTableRowAddition = "00A34D88", RsidTableRowProperties = "00A34D88" };
            ...
            Paragraph paragraph1 = new Paragraph() { RsidParagraphAddition = "00A34D88", RsidParagraphProperties = "00A34D88", RsidRunAdditionDefault = "00A34D88" };
            ...
            Run run1 = new Run() { RsidRunProperties = "0078673D" };

            RunProperties runProperties1 = new RunProperties();
            RunFonts runFonts1 = new RunFonts() { Ascii = "Courier New", HighAnsi = "Courier New", ComplexScript = "Courier New" };
            ...
            Paragraph paragraph2 = new Paragraph() { RsidParagraphAddition = "00A34D88", RsidParagraphProperties = "00A34D88", RsidRunAdditionDefault = "00A34D88" };
            ...
            Run run2 = new Run() { RsidRunProperties = "0078673D" };
            ...
            Paragraph paragraph3 = new Paragraph() { RsidParagraphAddition = "00A34D88", RsidParagraphProperties = "00A34D88", RsidRunAdditionDefault = "00A34D88" };
            ...
            Run run3 = new Run() { RsidRunProperties = "0078673D" };

            RunProperties runProperties3 = new RunProperties();
            RunFonts runFonts3 = new RunFonts() { Ascii = "Courier New", HighAnsi = "Courier New", ComplexScript = "Courier New" };
...
#endregion
#region "Row with data"
            /*
            TableRow tableRow2 = new TableRow() { RsidTableRowAddition = "00A34D88", RsidTableRowProperties = "00A34D88" };
            ...
            Paragraph paragraph4 = new Paragraph() { RsidParagraphAddition = "00A34D88", RsidParagraphProperties = "00A34D88", RsidRunAdditionDefault = "00A34D88" };
            ...
            Run run4 = new Run() { RsidRunProperties = "0078673D" };

            RunProperties runProperties4 = new RunProperties();
            RunFonts runFonts4 = new RunFonts() { Ascii = "Courier New", HighAnsi = "Courier New", ComplexScript = "Courier New" };
            Color color4 = new Color() { Val = "538135", ThemeColor = ThemeColorValues.Accent6, ThemeShade = "BF" };
            ...
            Paragraph paragraph5 = new Paragraph() { RsidParagraphAddition = "00A34D88", RsidParagraphProperties = "00A34D88", RsidRunAdditionDefault = "00A34D88" };
            ...
            Run run5 = new Run() { RsidRunProperties = "0078673D" };

            RunProperties runProperties5 = new RunProperties();
            RunFonts runFonts5 = new RunFonts() { Ascii = "Courier New", HighAnsi = "Courier New", ComplexScript = "Courier New" };
            Color color5 = new Color() { Val = "BC72B8" };
            ...
            Paragraph paragraph6 = new Paragraph() { RsidParagraphAddition = "00A34D88", RsidParagraphProperties = "00A34D88", RsidRunAdditionDefault = "00A34D88" };
            ...
            Run run6 = new Run() { RsidRunProperties = "0078673D" };

            RunProperties runProperties6 = new RunProperties();
            RunFonts runFonts6 = new RunFonts() { Ascii = "Courier New", HighAnsi = "Courier New", ComplexScript = "Courier New" };
            Color color6 = new Color() { Val = "538135", ThemeColor = ThemeColorValues.Accent6, ThemeShade = "BF" };
...
#endregion
#region "Clean Row"
            /*TableRow tableRow3 = new TableRow() { RsidTableRowAddition = "00A34D88", RsidTableRowProperties = "00A34D88" };
            ...
            Paragraph paragraph7 = new Paragraph() { RsidParagraphMarkRevision = "0078673D", RsidParagraphAddition = "00A34D88", RsidParagraphProperties = "00A34D88", RsidRunAdditionDefault = "00A34D88" };

            ParagraphProperties paragraphProperties7 = new ParagraphProperties();
            Justification justification7 = new Justification() { Val = JustificationValues.Center };

            ParagraphMarkRunProperties paragraphMarkRunProperties1 = new ParagraphMarkRunProperties();
            RunFonts runFonts7 = new RunFonts() { Ascii = "Courier New", HighAnsi = "Courier New", ComplexScript = "Courier New" };
            Color color7 = new Color() { Val = "538135", ThemeColor = ThemeColorValues.Accent6, ThemeShade = "BF" };
            Languages languages7 = new Languages() { Val = "en-US" };

            paragraphMarkRunProperties1.Append(runFonts7);
            paragraphMarkRunProperties1.Append(color7);
            paragraphMarkRunProperties1.Append(languages7);
            ...
            Paragraph paragraph8 = new Paragraph() { RsidParagraphMarkRevision = "0078673D", RsidParagraphAddition = "00A34D88", RsidParagraphProperties = "00A34D88", RsidRunAdditionDefault = "00A34D88" };

            ParagraphProperties paragraphProperties8 = new ParagraphProperties();
            Justification justification8 = new Justification() { Val = JustificationValues.Center };

            ParagraphMarkRunProperties paragraphMarkRunProperties2 = new ParagraphMarkRunProperties();
            RunFonts runFonts8 = new RunFonts() { Ascii = "Courier New", HighAnsi = "Courier New", ComplexScript = "Courier New" };
            Color color8 = new Color() { Val = "BC72B8" };
            Languages languages8 = new Languages() { Val = "en-US" };

            paragraphMarkRunProperties2.Append(runFonts8);
            paragraphMarkRunProperties2.Append(color8);
            paragraphMarkRunProperties2.Append(languages8);
            ...
            Paragraph paragraph9 = new Paragraph() { RsidParagraphMarkRevision = "0078673D", RsidParagraphAddition = "00A34D88", RsidParagraphProperties = "00A34D88", RsidRunAdditionDefault = "00A34D88" };

            ParagraphProperties paragraphProperties9 = new ParagraphProperties();
            Justification justification9 = new Justification() { Val = JustificationValues.Center };

            ParagraphMarkRunProperties paragraphMarkRunProperties3 = new ParagraphMarkRunProperties();
            RunFonts runFonts9 = new RunFonts() { Ascii = "Courier New", HighAnsi = "Courier New", ComplexScript = "Courier New" };
            Color color9 = new Color() { Val = "538135", ThemeColor = ThemeColorValues.Accent6, ThemeShade = "BF" };
            ...
            paragraphMarkRunProperties3.Append(languages9);

            paragraphProperties9.Append(justification9);
            paragraphProperties9.Append(paragraphMarkRunProperties3);
            ...
            table1.Append(makeHeader());
            //table1.Append(tableRow1);
            //table1.Append(tableRow2);
            foreach (var item in _items)
            {
                table1.Append(makeDataRow(item));
            }
            //table1.Append(tableRow3);
            Paragraph paragraph10 = new Paragraph() { RsidParagraphAddition = "006D1157", RsidRunAdditionDefault = "00A34D88" };

            SectionProperties sectionProperties1 = new SectionProperties() { RsidR = "006D1157" };
        ...
        private TableRow makeDataRow(TodoItem item)
        {
            TableRow tableRow2 = new TableRow() { RsidTableRowAddition = "00A34D88", RsidTableRowProperties = "00A34D88" };
        ...
        private void GenerateDocumentSettingsPart1Content(DocumentSettingsPart documentSettingsPart1)
        {
            ...
            RsidRoot rsidRoot1 = new RsidRoot() { Val = "00A34D88" };
            Rsid rsid1 = new Rsid() { Val = "00232180" };
            Rsid rsid2 = new Rsid() { Val = "00296FD6" };
            Rsid rsid3 = new Rsid() { Val = "00A12A4D" };
            Rsid rsid4 = new Rsid() { Val = "00A34D88" };
            ...
            OpenXmlUnknownElement openXmlUnknownElement2 = OpenXmlUnknownElement.CreateOpenXmlUnknownElement("<w15:docId w15:val=\"{3AF13693-658B-4450-824F-EC2A97E05DE2}\" xmlns:w15=\"http://schemas.microsoft.com/office/word/2012/wordml\" />");
        ...
        private void GenerateStyleDefinitionsPart1Content(StyleDefinitionsPart styleDefinitionsPart1)
        {
            ...
            RunFonts runFonts10 = new RunFonts() { AsciiTheme = ThemeFontValues.MinorHighAnsi, HighAnsiTheme = ThemeFontValues.MinorHighAnsi, EastAsiaTheme = ThemeFontValues.MinorHighAnsi, ComplexScriptTheme = ThemeFontValues.MinorBidi };
            FontSize fontSize1 = new FontSize() { Val = "22" };
            FontSizeComplexScript fontSizeComplexScript1 = new FontSizeComplexScript() { Val = "22" };
            Languages languages10 = new Languages() { Val = "ru-RU", EastAsia = "en-US", Bidi = "ar-SA" };

            runPropertiesBaseStyle1.Append(runFonts10);
            runPropertiesBaseStyle1.Append(fontSize1);
            runPropertiesBaseStyle1.Append(fontSizeComplexScript1);
            runPropertiesBaseStyle1.Append(languages10);
            ...
            Rsid rsid5 = new Rsid() { Val = "00A34D88" };
        ...
        {
            document.PackageProperties.Creator = "TodoAPI";
            document.PackageProperties.Title = "";
            document.PackageProperties.Subject = "";
            document.PackageProperties.Keywords = "";
            document.PackageProperties.Description = "TodoList";
            document.PackageProperties.Revision = "1";
            document.PackageProperties.Created = System.Xml.XmlConvert.ToDateTime("2018-04-07T16:31:00Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
            document.PackageProperties.Modified = System.Xml.XmlConvert.ToDateTime("2018-04-07T16:36:00Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
            document.PackageProperties.LastModifiedBy = "TodoAPI";
        }
    ...
    {
        private GeneratedClass _doc;
        public DocCreator(List<TodoItem> items)
        {
            _doc = new GeneratedClass(items);
        }

        public byte[] GetDocStream()
        {
            byte[] generatedBytes = _doc.CreatePackageAsBytes();
